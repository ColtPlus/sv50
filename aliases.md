...
syscon@fd588000 | | pmu0grf
syscon@fd58a000 | | pmu1grf
syscon@fd58c000 | disabled | sys_grf
syscon@fd590000 | | bigcore0-grf
syscon@fd592000 | | bigcore1-grf
syscon@fd594000 | | litcore-grf
syscon@fd598000 | | dsu-grf
syscon@fd5a0000 | | gpu-grf
syscon@fd5a2000 | | npu-grf
syscon@fd5a4000 | | vop_grf
syscon@fd5a6000 | | vo0_grf
syscon@fd5a8000 | | vo1_grf
syscon@fd5ac000 | | usb_grf
syscon@fd5b0000 | | php_grf
syscon@fd5b4000 | | csidphy0_grf
syscon@fd5b5000 | | csidphy1_grf
syscon@fd5bc000 | | pipe_phy0_grf
syscon@fd5c4000 | | pipe_phy2_grf
syscon@fd5c8000 | | usbdpphy0_grf
syscon@fd5d0000 | okay | usb2phy0_grf
syscon@fd5d8000 | okay | usb2phy2_grf
syscon@fd5dc000 | okay | usb2phy3_grf
syscon@fd5e0000 | | hdptxphy0_grf
syscon@fd5e8000 | | mipidcphy0_grf
syscon@fd5ec000 | | mipidcphy1_grf
syscon@fd5f0000 | | ioc
i2c@fd880000 | okay | i2c0
serial@fd890000 | okay | uart0
...
vdpu@fdb50400 | okay | vdpu
iommu@fdb50800 | okay | vpu121_mmu
avsd-plus@fdb51000 | disabled
rga@fdb60000 | okay | rga3_core0
iommu@fdb60f00 | okay
rga@fdb70000 | okay | rga3_core1
iommu@fdb70f00 | okay
rga@fdb80000 | okay | rga2_core0
jpegd@fdb90000 | okay | jpegd
iommu@fdb90480 | okay
...
iommu@fdcb7f00 | disabled
rkisp@fdcc0000 | disabled
iommu@fdcc7f00 | disabled
rkispp@fdcd0000 | disabled |
iommu@fdcd0f00 | disabled
rkispp@fdcd8000 | disabled |
iommu@fdcd8f00 | disabled
rkcif@fdce0000 | okay |
iommu@fdce0800 | okay
mipi0-csi2@fdd10000 | disabled |
mipi1-csi2@fdd20000 | okay | mipi1-csi2
...
dp@fde60000 | disabled | dp1
hdcp@fde70000 | disabled
hdmi@fde80000 | okay | hdmi0
hdmi@fdea0000 | disabled | hdmi1
edp@fdec0000 | disabled | edp0
edp@fded0000 | disabled | edp1
qos@fdf35000 | |
qos@fdf35200 | |
qos@fdf35400 | |
qos@fdf35600 | |
...
pcie@fe160000 | disabled | pcie3x2
pcie@fe170000 | disable | pcie2x1l0
pcie@fe180000 | disable | pcie2x1l1
pcie@fe190000 | okay | pcie2x1l2
ethernet@fe1b0000 | disabled | gmac0
ethernet@fe1c0000 | okay | gmac1
sata@fe210000 | disabled | sata0
sata@fe220000 | okay | sata1
...
i2s@fe4a0000 | disabled
pdm@fe4b0000 | disabled
pdm@fe4c0000 | disabled
vad@fe4d0000 | disabled
spdif-tx@fe4e0000 | disabled
spdif-tx@fe4f0000 | disabled
codec-digital@fe500000 | disabled
hwspinlock@fe5a0000 |
interrupt-controller@fe600000 |
dma-controller@fea10000 |
dma-controller@fea30000 |
can@fea50000 | disabled
can@fea60000 | disabled
can@fea70000 | disabled
decompress@fea80000 | disabled
i2c@fea90000 | | i2c1
i2c@feaa0000 | | i2c2
i2c@feab0000 | | i2c3
i2c@feac0000 | | i2c4
i2c@fead0000 | | i2c5
timer@feae0000 |
watchdog@feaf0000 | okay
spi@feb00000 | | spi0
spi@feb10000 | | spi1
spi@feb20000 | | spi2
spi@feb30000 | | spi3
serial@feb40000 | disabled | uart1
serial@feb50000 | disabled | uart2
serial@feb60000 | disabled | uart3
serial@feb70000 | disabled | uart4
serial@feb80000 | okay | uart5
serial@feb90000 | disabled | uart6
serial@feba0000 | disabled | uart7
serial@febb0000 | disabled | uart8
serial@febc0000 | disabled | uart9
pwm@febd0000 | disabled
pwm@febd0010 | disabled
pwm@febd0020 | disabled
pwm@febd0030 | disabled
pwm@febe0000 | disabled
pwm@febe0010 | disabled
pwm@febe0020 | disabled
pwm@febe0030 | disabled
pwm@febf0000 | disabled
pwm@febf0010 | disabled
pwm@febf0020 | disabled
pwm@febf0030 | disabled
tsadc@fec00000 | okay
saradc@fec10000 | okay
mailbox@fec60000 | disabled
mailbox@fec70000 | disabled
i2c@fec80000 | | i2c6
i2c@fec90000 | | i2c7
i2c@feca0000 | | i2c8
spi@fecb0000 | | spi4
otp@fecc0000 |
mailbox@fece0000 | disabled
dma-controller@fed10000 |
phy@fed60000 | | hdptxphy0
hdmiphy@fed60000 | |
phy@fed70000 | disabled | hdptxphy1
hdmiphy@fed70000 | okay |
phy@fed80000 | | usbdp_phy0
phy@feda0000 | okay |
phy@fedb0000 | okay |
csi2-dphy0-hw@fedc0000 | disabled |
phy@fee00000 | okay |
phy@fee20000 | okay |
